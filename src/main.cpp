...
int main(int argc, char** argv) {
  ...
  pt.put("BurnIn", 5);
  pt.put("NumSamples_0", parameterReader.getNumberOfSamples(0));
  pt.put("NumSamples_1", parameterReader.getNumberOfSamples(1));
  pt.put("NumSamples_2", parameterReader.getNumberOfSamples(2));
